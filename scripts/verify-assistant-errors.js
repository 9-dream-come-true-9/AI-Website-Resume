...
assert(!script.includes('assistantNoContentTimeoutMs'), 'The 8-second no-content timeout must be removed');
assert(!script.includes('timedOutBeforeContent'), 'The fixed no-content timeout branch must be removed');
